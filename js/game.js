...
window.addEventListener('load', function() {
	...
	scoresRef = firebase.database().ref('/scores').orderByChild('scores').limitToLast(10);
...
function playGame(){
	...
	info.innerHTML = 'แตะที่จอเพื่อเคลื่อนที่ไปข้างหน้า<br/>หาเหรียญให้ครบ<br/>ระวังต้นตะบองเพชรให้ดี';
}
...
function updateIndicators(){
	scoreBoard.innerHTML = 'Stage : '+level+'&nbsp;&nbsp;&nbsp; <img src="img/coin.png" alt="coin" style="margin-bottom:-2px"> x '+items.length+'&nbsp;&nbsp;&nbsp; Score : '+score;
